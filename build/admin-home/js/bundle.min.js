...
!function(){function a(a,e,t){function n(){console.log("getUserDetail"),e.Api.getMerchantBankCard(r).then(function(a){if(e.Log.d(a),a.data){o.bankCards=a.data.merchantbankcard,o.goods=a.data.merchantgoods;var t=a.data.merchant;t&&(o.name=t.mname,o.tel=t.tel,o.address=t.maddress,t.mremark?o.remark=t.mremark:o.remark="无优惠信息",o.logo=e.Const.NET.IMG_RUL+t.mavitor,e.Log.d(o.logo),o.license=e.Const.NET.IMG_RUL+t.businesslicense)}})}var o=a;e.Log.d("init"),e.Log.d(t.data);var r=t.data;n(),o.onSelect=function(a){e.Api.deleteMerchantGoodByGid(e.Data.get("aid"),a).then(function(a){e.Log.d(a),0==a.status&&n()})},o.onUpdateName=function(){e.Api.updateMerInfoNameByMid(e.Data.get("aid"),r,o.updateName).then(function(a){e.Log.d(a),0==a.status&&n()})}}angular.module("app").controller("merchant.DetailController",["$scope","Core","$stateParams",a])}();
!function(){function a(a,t){function e(){t.Log.d("init"),t.Api.queryAllMerchant(i,l).then(function(a){if(t.Log.d(a),0==a.status){if(a.data.data){for(var e=0;e<a.data.data.length;e++)"[]"==a.data.data[e].tel&&(a.data.data[e].tel="无");o.itemList=a.data.data}var n=a.data.count;d(n)}else t.Notify.info("获取商户失败")})}function n(a){t.Log.d("select mer"+a),t.go("admin.merchant-detail",a)}function d(a){$("#callBackPager").extendPagination({totalCount:a,showCount:10,limit:10,callback:function(a,e,n){t.Log.d("totalCount "+n),o.name?t.Api.queryMerchantByName(o.name,a,e).then(function(a){if(t.Log.d(a),0==a.status){if(a.data.data){for(var e=0;e<a.data.data.length;e++)"[]"==a.data.data[e].tel&&(a.data.data[e].tel="无");o.itemList=a.data.data}}else t.Notify.info("获取商户失败")}):t.Api.queryAllMerchant(a,e).then(function(a){if(t.Log.d(a),0==a.status){if(a.data.data){for(var e=0;e<a.data.data.length;e++)"[]"==a.data.data[e].tel&&(a.data.data[e].tel="无");o.itemList=a.data.data}}else t.Notify.info("获取商户失败")})}})}var o=a,i=1,l=10;o.onSelect=n,e(),o.onSearch=function(){t.Api.queryMerchantByName(o.name,1,10).then(function(a){if(t.Log.d(a),0==a.status){if(a.data.data){for(var e=0;e<a.data.data.length;e++)"[]"==a.data.data[e].tel&&(a.data.data[e].tel="无");o.itemList=a.data.data}var n=a.data.count;d(n)}else t.Notify.info("获取商户失败")})}}angular.module("app").controller("merchant.ManageController",["$scope","Core",a])}();
...
!function(){function o(o,t,n){function a(){t.Log.d("init"),t.Log.d(t.Data.get("aid")),t.Api.getSoftVersionList().then(function(o){t.Log.d(o);for(var n=o.data,a=0;a<n.length;a++)"0"==n[a].softname?(n[a].softname="客户端",n[a].flag=0):(n[a].softname="商户端",n[a].flag=1);f.itemList=n})}function e(){t.Api.saveSoftVersion(l,r,f.softversion,f.versioncode).then(function(o){0==o.status?a():t.Notify.info("更新失败")})}function s(o){i=o,f.isprogress=!1,f.isButton=!0,f.state="点击上传",f.softname=o.softname,l=0==o.flag?0:1}var i,r,f=o;f.onSelect=s,f.onUpdate=e;var l=0;a(),o.uploadImg="",f.upload=function(o){n.upload({url:t.Const.NET.FILE_UPLOAD,data:{file:o,flag:l}}).then(function(o){f.isprogress=!1,f.isButton=!0,f.state="上传完成";var n=o.data;r=n.data.fileName,t.Log.d(r)},function(o){t.Log.d("error"),t.Log.d(o)},function(o){f.isprogress=!0,f.isButton=!1;var n=f.vm={};n.value=parseInt(100*o.loaded/o.total),console.log("progress: "+f.progress+"% "),t.Log.d(o)})}}angular.module("app").controller("version.ManageController",["$scope","Core","Upload",o])}();
