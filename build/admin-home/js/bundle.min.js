...
!function(){function a(a,e,r){function t(){console.log("getUserDetail"),e.Api.getMerchantBankCard(o).then(function(a){if(e.Log.d(a),a.data){n.bankCards=a.data.merchantbankcard,n.goods=a.data.merchantgoods;var r=a.data.merchant;r&&(n.name=r.mname,n.tel=r.tel,n.address=r.maddress,r.mremark?n.remark=r.mremark:n.remark="无优惠信息",n.logo=e.Const.NET.IMG_RUL+r.mavitor,e.Log.d(n.logo),n.license=e.Const.NET.IMG_RUL+r.businesslicense)}})}var n=a;e.Log.d("init"),e.Log.d(r.data);var o=r.data;t()}angular.module("app").controller("merchant.DetailController",["$scope","Core","$stateParams",a])}();
