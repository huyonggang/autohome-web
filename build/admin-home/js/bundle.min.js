...
!function(){function a(a,t,e){function n(){console.log("getUserDetail"),t.Api.getMerchantBankCard(r).then(function(a){if(t.Log.d(a),a.data){o.bankCards=a.data.merchantbankcard,o.goods=a.data.merchantgoods;var e=a.data.merchant;e&&(o.name=e.mname,o.tel=e.tel,o.address=e.maddress)}})}var o=a;t.Log.d("init"),t.Log.d(e.data);var r=e.data;n()}angular.module("app").controller("merchant.DetailController",["$scope","Core","$stateParams",a])}();
