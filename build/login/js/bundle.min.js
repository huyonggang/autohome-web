...
angular.module("templates").run(["$templateCache", function($templateCache) {$templateCache.put("login/login.html","<div class=\"signinpanel\">\n    <div class=\"row\">\n        <div class=\"col-sm-12\">\n            <h2 style=\"margin-bottom: 100px\">惠众车服后台管理系统</h2>\n\n            <input ng-model=\"name\" type=\"text\" class=\"form-control uname\" placeholder=\"用户名\"/>\n            <input ng-model=\"password\" type=\"password\" class=\"form-control pword m-b\" placeholder=\"密码\"/>\n            <button ng-click=\"login()\" class=\"btn btn-success btn-block\">登录</button>\n        </div>\n    </div>\n</div>\n\n");}]);
!function(){function o(o,n){function i(){console.log("login"),n.Api.login(l.name,l.password).then(function(o){n.Log.d(o),console.log(o),0==o.status?(n.Notify.info("登录成功"),n.Data.set("aid",o.data.aid),n.Data.set(),n.go("admin.user")):n.Notify.info("用户名或密码错误")})}var l=o;console.log("hLoginController init"),l.login=i}angular.module("app").controller("login.LoginController",["$scope","Core",o])}();